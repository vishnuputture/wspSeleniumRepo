...
public class SpecialPricingAllowance extends ReusableLib {
    ...
    public ArrayList<String> getColumnValue(String columnNo) {
        ...
        int size = driver.findElements(By.xpath("//div[starts-with(@id,'D_') and (@class='A20')]")).size() - 1;
        Boolean bl = Utility_Functions.xIsDisplayed(driver, SpecialPriceAllowancePage.bottom);
        while (bl != true) {
            bl = Utility_Functions.xIsDisplayed(driver, SpecialPriceAllowancePage.bottom);
            for (int i = 1; i <= size; i++) {
                try {
                    al.add(driver.findElement(By.xpath("(//div[starts-with(@id,'D_" + count + "') and (@class='A20')])[" + columnNo + "]")).getText());
                    count++;
                } catch (Exception e) {
                    break;
                }
    ...
    public void showContractOrShowDate() {
        String sortValue = driver.findElement(SpecialPriceAllowancePage.showContractDate).getAttribute("value");
        String value[] = sortValue.split("=");
        click(SpecialPriceAllowancePage.showContractDate, "Click " + sortValue + "");
        String colmVal = Utility_Functions.getText(driver, SpecialPriceAllowancePage.contractStartDate);
        ...
        String sortVal = driver.findElement(SpecialPriceAllowancePage.showContractDate).getAttribute("value");
        ...
        String startDate = Utility_Functions.getText(driver, SpecialPriceAllowancePage.contractStartDate);
        String endDate = Utility_Functions.getText(driver, SpecialPriceAllowancePage.endDate);
    ...
    public void editContractRec() {
        ...
        Utility_Functions.xAssertEquals(report, Utility_Functions.getText(driver, SpecialPriceAllowancePage.contractJobName).trim(), name, "Contract Name after edit:");
        ...
        Utility_Functions.xAssertEquals(report, Utility_Functions.getText(driver, SpecialPriceAllowancePage.startDate).trim(), startDate, "Start Date after edit:");
        Utility_Functions.xAssertEquals(report, Utility_Functions.getText(driver, SpecialPriceAllowancePage.endDat).trim(), endDate, "End Date after edit:");
        Utility_Functions.xAssertEquals(report, Utility_Functions.getText(driver, SpecialPriceAllowancePage.vendNo).trim(), jsonData.getData("VendorNo"), "Vendor No after edit:");
        Utility_Functions.xAssertEquals(report, Utility_Functions.getText(driver, SpecialPriceAllowancePage.groupNo).trim(), jsonData.getData("GroupNo"), "Group No after edit:");
        click(SpecialPriceAllowancePage.btnReturn, "Click F12=Return");
    }
    ...
    public void editAndAddMoreGroups() {
        ...
        if (Utility_Functions.getText(driver, SpecialPriceAllowancePage.lblSuccess).equals(erMessage)) {
            String message = Utility_Functions.getText(driver, SpecialPriceAllowancePage.lblSuccess);
            Utility_Functions.xAssertEquals(report, message, erMessage, "Message: ");
        } else {
            String exNo = driver.findElement(SpecialPriceAllowancePage.exGroupNo).getAttribute("value");
    ...
    public void displayCustomer() {
        ...
        String grpName = driver.findElement(SpecialPriceAllowancePage.grpName).getAttribute("value");
    ...
    public void deleteCustomer() {
        ...
        verifySpaChangeContractTitle("Customer Group Browse ()");
        Boolean bl = Utility_Functions.xIsDisplayed(driver, By.xpath("//div[text()='" + grpName + "']"));
    ...
    public void copyContractDetail() {
        ...
        String name = Utility_Functions.xGenerateAlphaNumericString();
        sendKeys(SpecialPriceAllowancePage.txtBoxContractname, name, "Edit contract name");
        String exStartDate = driver.findElement(SpecialPriceAllowancePage.txtBoxStartDate).getAttribute("value").trim();
        String exEndDate = driver.findElement(SpecialPriceAllowancePage.txtBoxEndDate).getAttribute("value").trim();
        String exVendorNo = driver.findElement(SpecialPriceAllowancePage.txtBoxVendorNo).getAttribute("value").trim();
        String exGroupNo = driver.findElement(SpecialPriceAllowancePage.txtBoxGroupNo).getAttribute("value").trim();
        String exGroupName = Utility_Functions.getText(driver, SpecialPriceAllowancePage.exGroupName).trim();
        String exVendorName = Utility_Functions.getText(driver, SpecialPriceAllowancePage.vendorName).trim();
        String exSpecPricing = Utility_Functions.getText(driver, SpecialPriceAllowancePage.specialPricing).trim();
        String status = Utility_Functions.getText(driver, SpecialPriceAllowancePage.status).trim();
        Utility_Functions.actionKey(Keys.ENTER, driver);
        Utility_Functions.actionKey(Keys.ENTER, driver);
        String successMessage = Utility_Functions.getText(driver, SpecialPriceAllowancePage.lblSuccess);
        System.out.println("Text: " + successMessage);
        ...
        optTextBox("5", "Enter 5 to Display Edited Contract/Job Name Record");
        String actContractName = Utility_Functions.getText(driver, SpecialPriceAllowancePage.contractJobName).trim();
        String actStartDate = Utility_Functions.getText(driver, SpecialPriceAllowancePage.startDate).trim();
        String actEndDate = Utility_Functions.getText(driver, SpecialPriceAllowancePage.endDat).trim();
        String actStatus = Utility_Functions.getText(driver, SpecialPriceAllowancePage.status).trim();
        String actVendorNo = Utility_Functions.getText(driver, SpecialPriceAllowancePage.vendNo).trim();
        String actGroupName = Utility_Functions.getText(driver, SpecialPriceAllowancePage.exGroupName).trim();
        String actGroupNo = Utility_Functions.getText(driver, SpecialPriceAllowancePage.groupNo).trim();
        String actVendorName = Utility_Functions.getText(driver, SpecialPriceAllowancePage.vendorName).trim();
        String actSpecPricing = Utility_Functions.getText(driver, SpecialPriceAllowancePage.specialPricing).trim();
    ...
    public void verifySP(String spStatus, String message) {
        ...
        if (Utility_Functions.xIsDisplayed(driver, SpecialPriceAllowancePage.lblSuccess)) {
            successMessage = Utility_Functions.getText(driver, SpecialPriceAllowancePage.lblSuccess);
        } else {
            successMessage = Utility_Functions.getText(driver, SpecialPriceAllowancePage.loadedSuccess);
        }
        System.out.println("Text: " + successMessage);
        Utility_Functions.xAssertEquals(report, message, successMessage.trim(), "Validating success message");
        click(SpecialPriceAllowancePage.btnReturn, "CLick F12=Return");
        Utility_Functions.xAssertEquals(report, spStatus, Utility_Functions.getText(driver, SpecialPriceAllowancePage.SP).trim(), "Validating S/P");
    }
    ...
    public void loadSpecialPricing() {
        ...
        String expVendorNo = Utility_Functions.getText(driver, SpecialPriceAllowancePage.vendNo).trim();
        String expContractName = Utility_Functions.getText(driver, SpecialPriceAllowancePage.startDate).trim();
    ...
    public void updateCost() {
        ...
        String succ = Utility_Functions.getText(driver, SpecialPriceAllowancePage.codeUpdateSuccess);
    ...
    public void verifyColRebateSell() {
        Utility_Functions.xIsElementDisplayed(report, driver.findElement(SpecialPriceAllowancePage.rebateCostCol), "Rebate Cost column is displayed");
        Utility_Functions.xIsElementDisplayed(report, driver.findElement(SpecialPriceAllowancePage.rebateAmtCol), "Rebate Amount column is displayed");
        Utility_Functions.xIsElementDisplayed(report, driver.findElement(SpecialPriceAllowancePage.rebateMulTp), "rebate Mul. Type column is displayed");

        click(SpecialPriceAllowancePage.debateAm, "Click F5=Right/Selling");
        Utility_Functions.xIsElementDisplayed(report, driver.findElement(SpecialPriceAllowancePage.rebateCostCol), "Sell Price:");
        Utility_Functions.xIsElementDisplayed(report, driver.findElement(SpecialPriceAllowancePage.selMult), "Selling Multiplier Type :");
    }
    ...
    public void displayContractDetail() {
        ...
        verifySpaChangeContractTitle("SPA - Contract Browse");
        String contName = Utility_Functions.getText(driver, SpecialPriceAllowancePage.contractJobName).trim();
        String vendNo = Utility_Functions.getText(driver, SpecialPriceAllowancePage.vendNo).trim();
        String vendName = Utility_Functions.getText(driver, SpecialPriceAllowancePage.vendorName).trim();
        String groupName = Utility_Functions.getText(driver, SpecialPriceAllowancePage.exGroupName).trim();
        String groupNo = Utility_Functions.getText(driver, SpecialPriceAllowancePage.groupNo).trim();
        ...
        Utility_Functions.xAssertEquals(report, contName, Utility_Functions.getText(driver, SpecialPriceAllowancePage.startDate).trim(), "Start Date");
        Utility_Functions.xAssertEquals(report, vendNo, Utility_Functions.getText(driver, SpecialPriceAllowancePage.vendNo).trim(), "Vendor No:");
        Utility_Functions.xAssertEquals(report, vendName, Utility_Functions.getText(driver, SpecialPriceAllowancePage.venNameMfPd).trim(), "Vendor Name:");
        if (Utility_Functions.xIsDisplayed(driver, SpecialPriceAllowancePage.noRecordsMsg)) {
            Utility_Functions.xAssertEquals(report, "* NO RECORDS TO DISPLAY *", Utility_Functions.getText(driver, SpecialPriceAllowancePage.noRecordsMsg).trim(), "Vendor Name:");
        } else {
        ...
        Utility_Functions.xIsElementDisplayed(report, driver.findElement(SpecialPriceAllowancePage.showDesc), "Item Description is displayed");
        click(SpecialPriceAllowancePage.individualItem, "Click F8=Hide Desc");
        Boolean bl = Utility_Functions.xIsDisplayed(driver, SpecialPriceAllowancePage.showDesc);
        Utility_Functions.xAssertEquals(report, "" + bl + "", "false", "Hide Item Description:");

        Utility_Functions.xAssertEquals(report, contName, Utility_Functions.getText(driver, SpecialPriceAllowancePage.contractJobName).trim(), "Contract Name:");
        Utility_Functions.xAssertEquals(report, vendNo, Utility_Functions.getText(driver, SpecialPriceAllowancePage.startDate).trim(), "Vendor No:");
        Utility_Functions.xAssertEquals(report, vendName, Utility_Functions.getText(driver, SpecialPriceAllowancePage.vendNo).trim(), "Vendor Name:");

        click(SpecialPriceAllowancePage.assignedGroups, "CLick F2=Assigned Groups");
        verifySpaChangeContractTitle("Customer Group Browse ()");
        Utility_Functions.xAssertEquals(report, groupName, Utility_Functions.getText(driver, SpecialPriceAllowancePage.gName).trim(), "Group Name:");
        Utility_Functions.xAssertEquals(report, groupNo, Utility_Functions.getText(driver, SpecialPriceAllowancePage.grpNum).trim(), "Group No:");
    ...
    public void deleteRec(String deleteRec) {
        ...
        Utility_Functions.waitForElementVisible(driver, SpecialPriceAllowancePage.btnDelete, 10);
        click(SpecialPriceAllowancePage.btnDelete, "CLick F9=Delete Record");
    ...
    public void assignMfPd() {
        ...
        if (Utility_Functions.xIsDisplayed(driver, SpecialPriceAllowancePage.xCode)) {
        ...
        Utility_Functions.actionKey(Keys.ENTER, driver);
        Utility_Functions.actionKey(Keys.ENTER, driver);
        String mes = Utility_Functions.getText(driver, SpecialPriceAllowancePage.lblSuccess).trim();
        ...
        verifySpaChangeContractTitle("SPA - Change Contract");
        click(SpecialPriceAllowancePage.btnHideShowExpired, "Click F7=MF/PD Codes");
        Boolean bl = Utility_Functions.xIsDisplayed(driver, SpecialPriceAllowancePage.xCode);
    ...
    public void assignIndividualItem() {
        ...
        String title = getText(SpecialPriceAllowancePage.appHeader).trim();
        Utility_Functions.xAssertEquals(report, title, "Work With SPA Items - Rebate Details", "Page Title: ");
        if (Utility_Functions.xIsDisplayed(driver, SpecialPriceAllowancePage.firstItemNo)) {
            firstItemNo = Utility_Functions.getText(driver, SpecialPriceAllowancePage.firstItemNo);
