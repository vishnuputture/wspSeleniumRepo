...
public class WiseSmokeTest extends ReusableLib {
    ...
    public void salesQuotedtllines(){
        commonObj.validateText(WiseSmokeTestPage.SQTitle,"Sales Quote Detail Lines","Validating  sales quotes detail lines page title");
        ...
        //sendKeysAndEnter(WiseSmokeTestPage.SQOptionsDD, "13", "Typing in 13 to convert and pressing Enter");
    ...
    public void salesOrderSelectionfromInq() {
        ...
        // sendKeys(WiseSmokeTestPage.SOline2, jsonData.getData("SODDOption"),"Enter 9 to navigate to SOE");
        Utility_Functions.actionKey(Keys.ENTER, ownDriver);
